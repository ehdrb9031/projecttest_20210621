...
<table border="1" class="table table-hover">
	...
	<tr>
		...
		<%
				...
				%>					
					<button class="btn btn-primary" type="button" onclick="location.href='OffController.do?command=offva&seq=<%=oDto.getOff_seq() %>&id=<%=oDto.getId()%>&odate=<%=oDto.getOdate()%>&wdate=<%=oDto.getWdate()%>'">승인</button>
